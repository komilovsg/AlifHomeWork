class Product {
  ...
  getDetails() {
    return `Название: ${this.name}, Цена: ${this.price}, Категория: ${this.category}`;
  }
}
...
electronics.forEach((product) => console.log(product.getDetails()));

const productInfo = store.mapProducts();
console.log("\nИнформация о товарах (названия и цены):");
